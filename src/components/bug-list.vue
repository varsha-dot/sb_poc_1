<template>
    <!-- <button @click = "bugDetails">Bug List</button> -->
    <div v-show="bugDisabled"><br /><br /><br /><br />
        ...
        <tbody style="color:gainsboro">
          <tr v-for="list of storyList" :key="list.id" v-show="list.Type === 'bug'"> 
                <td> {{ list.id }} </td>
                <td> {{ list.Name }} </td>
...
import axios from 'axios'
    ...
    export default {
        ...
        methods: {
            ...
            bugDetails() {
                this.bugDisabled = !this.bugDisabled
            }
        }, mounted() {
            this.getDetails();
        },
